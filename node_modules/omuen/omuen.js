...
omuen.handle = function(opt){
  ...
  ret.execute = function(request, response){
    ...
    if(h){
      request.data = { source:"", querystring: {}, form: {} };
      ...
      switch(request.method){
        ...
        case "POST" :{
          ...
          request.on("end", function(){
            request.data.source = reader.read()||"";
            request.data.form = qs.parse(request.data.source.toString());  
  ...
  ret.listen = function(port){
    ...
    server.on("connection",function(socket){
      //console.log("[" + omuen.now() + "] connected: %s:%s" , socket.remoteAddress, socket.remotePort);
      sockets.push(socket);
